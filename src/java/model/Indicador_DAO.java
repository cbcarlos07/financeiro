...
public class Indicador_DAO {
    ...
    public List<Financeiro> getLeitos(){
        ...
        try {
            ...
            Logger.getLogger(Indicador_DAO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lista;
    ...
    public List<Financeiro> getPacienteInternado(){
        ...
        try {
            ...
            while(resultSet.next()){
               ...
               // System.out.println("Media do banco: "+resultSet.getString("PACIENTE_MEDIA"));
                financeiro.setMedia(String.valueOf(resultSet.getFloat("PACIENTE_MEDIA")).replace(".", ","));                
      ...
      public List<Financeiro> getCentroCirurgico(){
        ...
        lista = new ArrayList();
        sql =   " SELECT CENTRO_CIRURGICO CENTRO_CIRURGICO, ONTEM, MEDIA, ACUMULADO " +
      ...
      public List<Financeiro> getHemodinamica(){
        ...
        lista = new ArrayList();
        sql =   " SELECT HEMODINAMICA, ONTEM, MEDIA, ACUMULADO " +
